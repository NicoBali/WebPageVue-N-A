<template>
  <div class="contenedor-usuario">
    <div class="input-group mb-3">
      <input type="text" class="form-control" placeholder="Nombre completo" v-model="nombreCompleto" id="nombre-completo" />
    </div>
    <div class="input-group mb-3">
      <input type="email" class="form-control" placeholder="Correo electrónico" v-model="correoElectronico" id="correo-electronico" />
    </div>
    <div class="input-group mb-3">
      <textarea class="form-control" placeholder="Ocupación" v-model="ocupacion" id="ocupacion"></textarea>
    </div>
    <div class="input-group mb-3">
    ...
    <div class="contenedor-boton">
      <button class="stylish-button" @click="handleSubmit" id="registrar-talent-btn">Registrarme</button>
    </div>
